 ...
 * @author Alunos
 */
public class gestaoObj extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Professor", "Setor", "Objeto", "Descrição", "Horário"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gestaoObj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
